...
let populationNew=population+1;
let populationFinalnd=6;
let populationAverage=33;
let description=country+' is in '+continent+', and its '+population+' million people speak '+language;

console.log(populationHalf);
console.log(populationNew);
console.log(population>populationFinalnd);
...
let descriptionC= `${country} is in ${continent}, and its ${population} million people speak ${language}.`;
...
if(population>33){
    ...
    const diff = populationAverage - population;
